...
public class Vendedor extends Funcionario implements IVendedor{
    ...
    public Vendedor(String nome, String rg, String cpf, String setor,String cargo, float salario, float bunus,String especialidade) {
    ...
    public String retornaDados() {
        return "nome:"+getNome()+" rg:"+getRg()+"setor"+getSetor()+"cargo"+getCargo()+"salario"+getSalario()+"bonus"+getBonus()+"especialidade"+getEspecialidade();
    }
